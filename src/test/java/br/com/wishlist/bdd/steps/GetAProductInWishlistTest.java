...
public class GetAProductInWishlistTest extends CucumberSpringConfiguration {
    @Autowired
    private MockMvc mvc;
    ...
    @SneakyThrows
    public void createAWishlistWithSomeProduct() {
    ...
    @SneakyThrows
    public void retrieveAnExistentProductInWishlist() {
        result = mvc.perform(get("/customers/1/products/1")
                .contentType(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    }

    @Then("the client receives its product")
    @SneakyThrows
    public void receiveClientProductInWishlist() {
